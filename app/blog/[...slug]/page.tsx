          ...
          <div className="container mx-auto px-4 py-12 max-w-6xl">
            <div className="mb-8 flex justify-between items-center">
              {displayUser && (
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-3xl font-bold">{displayUser.name}'s Blog</h1>
            ...
            {posts.length === 0 ? (
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {posts.map((blogPost) => (
                  <Link key={blogPost.id} href={`/blog/${username}/${blogPost.slug}`}>
                    <Card className="hover:shadow-lg transition-shadow h-full overflow-hidden">
                      ...
                      <CardContent className="p-6 space-y-3">
                        <h3 className="font-bold text-xl line-clamp-2">{blogPost.title}</h3>
                        ...
                        <div className="flex items-center gap-4 text-sm text-muted-foreground pt-2">
                          <span className="flex items-center gap-1">
                            ...
                            {blogPost._count.likes}
                          </span>
                          <span className="flex items-center gap-1">
                            <MessageCircle className="h-4 w-4" />
                            {blogPost._count.comments}
                          </span>
      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 py-12 max-w-4xl">
          ...
          <div className="flex items-center justify-between mb-8 pb-6 border-b">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-xl font-semibold">{post!.user.name.charAt(0).toUpperCase()}</span>
              </div>
              <div>
          ...
          {isEditing ? (
            ...
            post!.excerpt && <p className="text-lg text-muted-foreground italic mb-8 leading-relaxed">{post!.excerpt}</p>
          )}
