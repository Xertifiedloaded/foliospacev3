...
import { FileText, Download, Share2, BarChart3, CheckCircle2, ArrowRight, Sparkles, Target, Zap, Clock, Shield } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1">
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  ...
                  <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-xl">
                    Build professional resumes that get past ATS systems and impress recruiters. Simple, fast, and effective.
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-white dark:bg-gray-950 border shadow-2xl rounded-xl p-10 max-w-lg">
                    ...
                    <div className="space-y-2 mb-6 pb-6 border-b border-gray-200 dark:border-gray-800">
                      <h3 className="text-xs font-bold text-gray-900 dark:text-gray-100 uppercase tracking-wider">Summary</h3>
                      <p className="text-xs text-gray-700 dark:text-gray-300 leading-relaxed">
                        Full Stack Engineer with 5+ years building scalable web applications using React, Next.js, and Node.js. Proven track record delivering high-impact solutions.
                      </p>
                    </div>

                    {/* Experience */}
                    <div className="space-y-3 mb-6 pb-6 border-b border-gray-200 dark:border-gray-800">
                      <h3 className="text-xs font-bold text-gray-900 dark:text-gray-100 uppercase tracking-wider">Experience</h3>
                      <div className="space-y-3">
                        <div>
                          <div className="flex justify-between items-start mb-1">
                            <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">Senior Full Stack Engineer</p>
                    ...
                    <div className="space-y-2">
                      <h3 className="text-xs font-bold text-gray-900 dark:text-gray-100 uppercase tracking-wider">Skills</h3>
                      <div className="flex flex-wrap gap-2">
                        <span className="px-2.5 py-1 bg-primary/10 text-primary border border-primary/20 rounded text-xs font-medium">React</span>
                        <span className="px-2.5 py-1 bg-primary/10 text-primary border border-primary/20 rounded text-xs font-medium">Node.js</span>
                        <span className="px-2.5 py-1 bg-primary/10 text-primary border border-primary/20 rounded text-xs font-medium">TypeScript</span>
                        <span className="px-2.5 py-1 bg-primary/10 text-primary border border-primary/20 rounded text-xs font-medium">AWS</span>
                        <span className="px-2.5 py-1 bg-primary/10 text-primary border border-primary/20 rounded text-xs font-medium">Docker</span>
                      </div>
                    </div>
                  </div>
        ...
        <section id="features" className="px-6 py-20 md:py-28  dark:bg-gray-900/50">
          <div className="max-w-7xl mx-auto">
        ...
        <section className="px-6 py-20 md:py-28  dark:bg-gray-900/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16 space-y-4">
        ...
        <section className="px-6 py-20 md:py-28">
          <div className="max-w-4xl mx-auto">
            <Card className="relative overflow-hidden p-12 md:p-16 bg-gradient-to-br from-primary to-primary/90 text-primary-foreground text-center border-0 shadow-xl">
              <div className="relative z-10 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                  {user ? (
                    ...
                    <>
                      ...
                      <Link href="/login" className="w-full sm:w-auto">
                        <Button size="lg" variant="outline" className="w-full text-base px-8 h-12 bg-transparent border-2 border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary">
                          Sign In
                        </Button>
                      </Link>
                    </>
                ...
                <p className="text-sm opacity-90 pt-2">
                  No credit card • Free forever • Export anytime
                </p>
              </div>
            </Card>
          </div>
